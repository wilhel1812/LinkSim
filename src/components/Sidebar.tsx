    ...
    <aside className="sidebar-panel">
      ...
      <section className="panel-section section-results">
        ...
        <div className="section-heading">
          ...
          <InfoTip text="Pass/Fail compares calibrated RX estimate to RX target. In map Pass/Fail view: green = pass clear, amber = pass with terrain penalty, red = fail. Terrain effects apply when ITM + terrain data are in use." />
        </div>
